@echo off
cd /d C:\Users\Administrator\AppData\LocalLow\ai-image-gen
...
git add .
git commit -m "feat: AI Image Generator v1.0"
git remote add origin git@github.com:ganbatian/ai-image-gen.git
git branch -M main
